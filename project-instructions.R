...
IN THIS PROJECT YOUR GOAL WILL BE TO USE DATA FROM THE ACCELEROMETERS ON THE BELT, FOREARM, ARM AND DUMBBELL OF 6 PARTICIPANTS.
...
1.	Your submission should consist of a link to a 
...
2.  You should also apply your machine learning 
	algorithm to the 20 test cases available in the test data above. 
